/*
1. SQL kóddá kell alakítani az excelt.
exceltools.xlam -> inline táblakonstruktor lekérdezést csinál az excelból, érdemes temp táblába tenni
...
from #list as list
inner join Product as p on p.ProductSubcategoryID = list.ProductSubCategoryID
